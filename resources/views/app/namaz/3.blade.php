        ...
        <div class="row mt-4 notranslate">
            <div class="col-12 col-md-8">
                <x-app.study-card :title="'ഏതൊരു ആരാധനയും രണ്ട് നിബന്ധനകൾ ഒത്താലല്ലാതെ സ്വീകരിക്കപ്പെടുകയില്ല.'">
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-2">1. ഇഖ്ലാസ്</h6>
                    <p class="m-0 mb-2">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-3">2. സുന്നത്ത്</h6>
                ...
                <x-app.study-card :title="'നമസ്കാരം സ്വീകാര്യമാകാനുള്ള നിബന്ധനകൾ മൂന്നെണ്ണമാകുന്നു.'">
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-2">1. ഇസ്‌ലാം (മുസ്ലിം ആയിരിക്കണം)</h6>
                    <p class="m-0 mb-2">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-3">2. ബുദ്ധി</h6>
                    <p class="m-0 mb-2">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-3">3. വകതിരിവ് (പ്രായപൂ൪ത്തിയാകുക)</h6>
                    <p class="m-0 mb-2">
                ...
                <x-app.study-card :title="'നമസ്കാരം ശരി ആവാനുള്ള നിബന്ധനകൾ ആറെണ്ണമാകുന്നു.'">
                    <h6 class="text-yl-900 fw-bold m-0 mb-1 mt-2">1. സമയമാകുക</h6>
                    <p class="m-0 mb-2">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mb-2 mt-3">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mt-3 mb-2">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mt-3 mb-2">4. ഔറത്ത് (നഗ്നത) മറക്കുക.</h6>
                    <p class="m-0 mb-1">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mt-3 mb-2">5. ഖിബ്‌’ലക്ക് മുന്നിടുക.</h6>
                    <p class="m-0 mb-1">
                    ...
                    <h6 class="text-yl-900 fw-bold m-0 mt-3 mb-2">6. നിയ്യത്ത്.</h6>
                    <p class="m-0 mb-1">
