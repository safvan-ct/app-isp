...
@section('content')
    ...
    <div class="container my-3 pb-5">
        ...
        <!-- Lesson Body -->
        <div class="p-1">
            <h5 class="text-emerald fw-bold text-center m-0">
            ...
            <h6 class="text-accent-900 fw-bold m-0 mb-2">1. ഇസ്‌ലാം (മുസ്ലിം ആയിരിക്കണം)</h6>
            ...
            <x-app.hadith-box class="mb-2" reference="അബു ദാവൂദ്: 495">
                <x-slot:text>
                    നിങ്ങളുടെ കുട്ടികൾക്ക് ഏഴ് വയസ്സാകുമ്പോൾ നിങ്ങൾ അവരോട് നമസ്കരിക്കാൻ കൽപ്പിക്കുക, പത്ത് വയസ്സാകുമ്പോൾ
                    അതിനായി അവരെ ശിക്ഷിക്കുക; അവരുടെ കിടക്കകൾ പ്രത്യേകം ക്രമീകരിക്കുക.
                </x-slot:text>
            </x-app.hadith-box>

            <h5 class="text-emerald fw-bold text-center m-0 mt-4">
                നമസ്കാരം ശരി ആവാനുള്ള നിബന്ധനകൾ അഞ്ചെണ്ണം ആവുന്നു.
            </h5>
            <hr class="mt-2 mb-3" style="border: none; border-top: 2px solid #166534; opacity: 1;">

            <h6 class="text-accent-900 fw-bold m-0 mb-2">1. അശുദ്ധമായ അവസ്ഥയില്‍നിന്നും ശരീരം ശുദ്ധമായിരിക്കുക</h6>
            <x-app.quran-box class="mb-2" reference="5:6">
                <x-slot:text>
                    ...
                    കഴുകുകയും, നിങ്ങളുടെ തല തടവുകയും നെരിയാണിവരെ രണ്ട് കാലുകള്‍ കഴുകുകയും ചെയ്യുക(വുദു). നിങ്ങള്‍ ജനാബത്ത്
                    (വലിയ അശുദ്ധി) ബാധിച്ചവരായാല്‍ നിങ്ങള്‍ (കുളിച്ച്‌) ശുദ്ധിയാകുക.
                </x-slot:text>
            </x-app.quran-box>
            ...
            <x-app.quran-box class="mb-2" reference="2:144,149-150">
                <x-slot:text>
                    ഏതൊരിടത്ത് നിന്ന് നീ പുറപ്പെടുകയാണെങ്കിലും മസ്ജിദുല്‍ ഹറാമിന്റെ നേര്‍ക്ക് (പ്രാര്‍ത്ഥനാവേളയില്‍) നിന്റെ
                    മുഖം തിരിക്കേണ്ടതാണ്‌.
                </x-slot:text>
            </x-app.quran-box>
        </div>
