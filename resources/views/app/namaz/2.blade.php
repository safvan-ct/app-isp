                ...
                <div class="ref-box ref-summary mt-0 rounded-0">
                    <ul class="m-0 ps-4">
                        ...
                        <li>
                            ...
                            <x-app.hadith-box class="mb-2" reference="മുസ്ലിം:1600,1601">
                                <x-slot:text>
                                    തണുത്തതും മഴയുള്ളതുമായ ഒരു രാത്രിയിൽ, നബി (സ) മുഅദ്ദിൻമാരോട് നിങ്ങളുടെ വീടുകളിൽ വെച്ച്
                                    നമസ്കരിക്കാൻ കൽപ്പിക്കാറുണ്ടായിരുന്നു.
                                </x-slot:text>
                            </x-app.hadith-box>
                        </li>
                    </ul>
