        ...
        <div class="lesson-body">
            ...
            <div class="summary-box">
                ...
                <ol class="m-0">
                    ...
                    <li>മുഅദ്ദിൻ → മുസ്ലിം, ബുദ്ധിശക്തിയുള്ള പുരുഷൻ. <em>ഇമാം ഉത്തരവാദിത്തമുള്ളവനും മുഅദ്ദീൻ
                            വിശ്വസ്തനുമാണ് - അബു ദാവൂദ്:517</em></li>
                </ol>
            </div>
            ...
            <p class="m-0">പ്രഭാത പ്രാർത്ഥനയാണെങ്കിൽ, നിങ്ങൾ ഉച്ചരിക്കണം: <span class="fs-3 text-ar">الصَّلَاةُ خَيْرٌ
                    مِنَ النَّوْمِ</span></p>
            ...
            <p class="reference-box mt-0 mb-1">
                ബിലാൽ (റ) നമസ്കാരത്തിന് അദാൻ ഉച്ചരിക്കുമ്പോൾ മുഖം അങ്ങോട്ടുമിങ്ങോട്ടും തിരിക്കുന്നത് ഞാൻ കണ്ടു. <em
                    class="small">- മുസ്ലിം: 634</em>
            </p>
            <p class="reference-box mt-0 mb-1">
                പ്രഭാത പ്രാർത്ഥനയാണെങ്കിൽ, നിങ്ങൾ ഉച്ചരിക്കണം: الصَّلَاةُ خَيْرٌ مِنَ النَّوْمِ <em class="small">- അബു
                    ദാവൂദ്: 500</em>
            </p>

            <h5 class="text-emerald fw-bold mt-3">അദാൻ കേൾക്കുമ്പോൾ</h5>
            <p class="reference-box mt-0 mb-1">
                നിങ്ങൾ അദാൻ കേൾക്കുമ്പോഴെല്ലാം മുആദിൻ പറയുന്നത് പോലെ പറയുക. <em class="small">- ബുഖാരി:611,
                    മുസ്ലിം:848,849</em>
            </p>
            <p class="reference-box mt-0 mb-1">
            ...
            <p class="reference-box mt-0 mb-1">
                ഖാദ്-ഖമത്ത്-ഇസ്-സലാത്ത് ഒഴികെയുള്ള ഇഖാമയുടെ പദങ്ങൾ ഒരിക്കൽ ഉച്ചരിക്കാൻ <em class="small">- ബുഖാരി:607,
                    മുസ്ലിം: 838</em>
            </p>

            <h5 class="text-emerald fw-bold mt-3">ഇഖാമത് കേൾക്കുമ്പോൾ</h5>
            <p class="reference-box mt-0">
                മുഅദ്ദീന്റെ വാക്കുകൾ കേൾക്കുമ്പോൾ, അവൻ പറയുന്നത് ആവർത്തിക്കുക. <em class="small">- ബുഖാരി:611,
                    മുസ്ലിം:848,849</em>
            </p>
