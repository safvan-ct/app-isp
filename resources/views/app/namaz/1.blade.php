        ...
        <div class="row mt-4">
            <div class="col-12 col-md-8">
                <x-app.content :title="'5 നമസ്കാരങ്ങളുടെ സമയക്രമം'">
                    <h6 class="text-accent-900 fw-bold m-0 my-2">1. സുബഹ് (ഫജ്ർ)</h6>
                    ...
                    <x-app.quran-box class="mb-2" reference="17:78">
                        <x-slot:text>
                            സൂര്യന്‍ (ആകാശമദ്ധ്യത്തില്‍ നിന്ന്‌) തെറ്റിയത് മുതല്‍ രാത്രി ഇരുട്ടുന്നത് വരെ നീ നമസ്കാരം
                            മുറപ്രകാരം നിര്‍വഹിക്കുക, ഖുര്‍ആന്‍ പാരായണം ചെയ്തുകൊണ്ടുള്ള പ്രഭാത
                            നമസ്കാരവും
                        </x-slot:text>
                    </x-app.quran-box>
                    ...
                    <x-app.hadith-box class="mb-2"
                        reference="മുസ്ലിം: 1385,1388-89, ബുഖാരി:541,556, അൽ-തിർമിധി:149,151-52">
                        <x-slot:text>
                            നമസ്കാര സമയങ്ങൾ
                        </x-slot:text>
                    </x-app.hadith-box>
                    ...
                    <x-app.hadith-box class="mb-2" reference="ബുഖാരി:527">
                        <x-slot:text>
                            നമസ്കാരം ആദ്യ സമയങ്ങളിൽ നമസ്കരിക്കുക.
                        </x-slot:text>
                    </x-app.hadith-box>
                </x-app.content>
            </div>
