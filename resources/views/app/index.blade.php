    ...
    <div class="container my-4 pb-5 notranslate">
        ...
        <section class="about-section mt-4">
            <div class="container">
                ...
                <div class="source-box mb-4">
                    <h4>പ്രധാന ഹദീസ് ഗ്രന്ഥങ്ങൾ (കുതുബുസ്സിത്ത)</h4>
                ...
                <div class="source-box mb-4">
                    <h4>ഓരോ മദ്ഹബിലെയും പ്രധാന ഗ്രന്ഥങ്ങൾ</h4>
                    <ul class="m-0" style="text-align: left">
                        <li><b>ഹനഫി മദ്ഹബ് (150H):</b> ഇമാം അബൂഹനീഫ (മരണം 150 AH). കിതാബുൽ ആഥാർ</li>
                        ...
                        <li><b>ഹംബലി മദ്ഹബ് (241H):</b> ഇമാം അഹ്മദ്. ഗ്രന്ഥം: മുസ്നദ് അഹ്മദ്</li>
                    </ul>
                </div>
            </div>
        </section>
