...
@section('content')
    ...
    <div class="container my-3 pb-5">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="authenticPanel">
            ...
            <div class="offcanvas-body py-0">
                <p class="ref-box ref-hadith mt-0" id="auth1">
                ...
                <p class="ref-box ref-hadith mt-0" id="auth2">
                ...
                <p class="ref-box ref-hadith mt-0">
                ...
                <p class="ref-box ref-hadith mt-0" id="auth3">
