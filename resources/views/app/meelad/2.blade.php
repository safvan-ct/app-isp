    ...
    <div class="container my-2 pb-5">
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content pb-1 bg-success-subtle">
                    ...
                    <ul>
                        <li>0 - 350 ഹി.: ആഘോഷമില്ല</li>
                        <li>583 ഹി.: സലാഹുദ്ദീൻ ജറുസലേം വീണ്ടെടുത്തപ്പോൾ (എർബിൽ) → പൊതുആഘോഷം</li>
                        <li>604 ഹി.: ഗോക്ക്‌ബുരി വലിയ മൗലിദ് നടത്തി (എർബിൽ)</li>
                        <li>1386 ഹി.: മത-സാംസ്കാരിക ആഘോഷം</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content pb-1 bg-success-subtle">
                    ...
                    <ul>
                        <li>
                            905 ഹി.: സൈനുദ്ദീൻ മഖ്ദൂം ഒന്നാമൻ "മൻഖൂസ് മൗലിദ്" എന്ന അറബി ഗ്രന്ഥം രചിച്ച് കേരളത്തിൽ മൗലിദ്
                            സാഹിത്യശാഖയ്ക്ക് തുടക്കമിട്ടു.
                        </li>
                        <li>925 - 982 ഹി.: മുഹ്‌യിദ്ദീൻ മാല - ഖാസി മുഹമ്മദ്</li>
                        <li>1111 ഹി.: രിഫാഇ മാല - മുഹമ്മദ് ഷാ (കൊണ്ടോട്ടി തങ്ങൾ)</li>
                        <li>1172 ഹി.: നഫീസത്ത് മാല - മമ്മദ് കുട്ടി ഹാജി</li>
                        <li>
                            ~ 906 1008 ഹി.:സൂഫി സ്വാധീനം. ഈ സമയത്താണ് മാലപ്പാട്ടുകൾ രചിക്കപ്പെട്ടതും മൗലിദ് സദസ്സുകൾ കൂടുതൽ
                            ജനകീയമായതും.
                        </li>
                        <li>1375 ഹി.: മത-സാംസ്കാരിക ആഘോഷം</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="base-card text-dark bg-warning-subtle shadow-sm border-0 rounded-3 mb-4">
            <div class="gap-3" bis_skin_checked="1">
                <p class="mb-2">
                    നബിദിനാഘോഷങ്ങൾ പ്രവാചക ﷺ കാലത്ത് ഉണ്ടായിരുന്നില്ല. ആദ്യമായി സർക്കാർ തലത്തിൽ ഫാതിമി ഖിലാഫത്ത് ആരംഭിച്ചു,
                    പിന്നീട് പൊതുസമൂഹത്തിലും എർബിൽ കാലത്ത് പ്രചരിച്ചു. മമ്ലുക് കാലത്ത് ഇത് പൊതുസമ്മേളനവും സാംസ്കാരിക
                    ഉത്സവവും ആയി മാറി.
                </p>
                <p class="mb-2">
                    ആധുനികകാലത്ത് മിക്ക മുസ്ലിം രാജ്യങ്ങളിലും മൗലിദ് ഔദ്യോഗിക അവധിയായി മാറി, ചിലയിടങ്ങളിൽ വിരോധം
                    നിലനിൽക്കുന്നു. കേരളത്തിൽ സൂഫി സ്വാധീനത്തോടെ മാലപ്പാട്ടുകൾ, മൗലിദ് സദസ്സുകൾ ജനകീയമായി വളർന്നു, പിന്നീട്
                    മത-സാംസ്കാരിക ആഘോഷമായി ഉറപ്പിച്ചു.
                </p>
                <p class="fst-italic text-muted m-0">
                    ക്രിസ്ത്യാനികൾ മർയമിന്റെ മകനെ പുകഴ്ത്തിയതുപോലെ എന്നെ നിങ്ങൾ പുകഴ്ത്തരുത്. <em>— ബുഖാരി: 3445</em><br>
